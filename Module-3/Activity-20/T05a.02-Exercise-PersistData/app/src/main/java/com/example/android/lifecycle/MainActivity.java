...
public class MainActivity extends AppCompatActivity {
    ...
    // TOD (3) Call super.onSaveInstanceState
    // TOO (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // TDO (5) Put the text from the TextView in the outState bundle
    // TOD (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
