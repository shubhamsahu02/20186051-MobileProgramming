...
public class MainActivity extends AppCompatActivity {
    ...
    // ODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TOO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay

        // TOO (5) Clear mLifecycleCallbacks after iterating through it
     ...
     */
    // TOO (2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        super.onDestroy();
        // ODO (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
